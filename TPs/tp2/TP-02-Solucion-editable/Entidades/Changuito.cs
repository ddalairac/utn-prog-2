...
namespace Entidades_2018
{
    ...
    public sealed class Changuito
    {
        ...
        public static string Mostrar(Changuito c, ETipo tipo)
        {
            ...
            {
                if ((tipo == ETipo.Snacks || tipo == ETipo.Todos) && prod is Snacks)
                {
                    sb.AppendLine(((Snacks)prod).Mostrar());
                }
                if ((tipo == ETipo.Dulce || tipo == ETipo.Todos) && prod is Dulce)
                {
                    sb.AppendLine(((Dulce)prod).Mostrar());
                }
                if ((tipo == ETipo.Leche || tipo == ETipo.Todos) && prod is Leche)
                {
